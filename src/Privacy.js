  ...
  return (
    ...
    <section>
      <div className={`${classes.root} container`}>
        ...
        <p>
          Pawndr, Inc (Pawndr) values its users’ privacy. This Privacy Policy
          ...
          facilities and services, and what we will and will not do with the
          information we collect. Our Policy has been designed and created to
          ensure those affiliated with Pawndr, Inc of our commitment and
        ...
        <p>
          ...
          in time Pawndr, Inc decides to make use of any personally identifiable
          ...
          users shall be promptly notified by email. Users at that time shall
          have the option as to whether to permit the use of their information
          in this separate manner.
        </p>
        <p>
          This Policy applies to Pawndr, Inc, and it governs any and all data
          collection and usage by us. Through the use of www.gopawndr.com , you
          are therefore consenting to the data collection procedures expressed
          in this Policy.
        </p>
        <p>
          Please note that this Policy does not govern the collection and use of
          information by companies that Pawndr, Incdoes not control, nor by
        ...
        <p>
          Pawndr, Incmay also deem it necessary, from time to time, to follow
        ...
        <p>
          ...
          it was requested, and any additional uses specifically provided for on
          this Policy.
        </p>
        ...
        <ul>
          ...
          <li>
            To fulfil our legitimate interest in improving our services and
            products;
          </li>
          <li>
          ...
          <li>
            To customise our website according to your online behaviour and
        ...
        <p>
          Pawndr, Inc does not now, nor will it in the future, sell, rent or
          lease any of its customer lists and/or names to any third parties.
        </p>
        <p>
          Pawndr, Inc may collect and may make use of personal information to
          ...
          available to you from www.gopawndr.com
        </p>
        <p>
          Pawndr, Inc may also be in contact with you with regards to completing
        ...
        <p>
          Pawndr, Incmay feel it necessary, from time to time, to contact you on
          behalf of our other external business partners with regards to a
        ...
        <p>
          Pawndr, Inc may find it beneficial to all our customers to share
          ...
          deliver support and/or arrange for deliveries to be made. Those third
          parties shall be strictly prohibited from making use of your personal
        ...
        <p>
          Pawndr, Incuses various third-party social media features including
          but not limited to http://www.instagram.com/gopawndr,
          http://www.twitter.com/gopawndr and other interactive programs. These
          ...
          and are not within Pawndr, Inc’s control.
        </p>
        <h3>Disclosure of Information</h3>
        <p>
          Pawndr, Inc may not use or disclose the information provided by you
        ...
        <ul>
          ...
          <li>
            ...
            property ofPawndr, Inc.
          </li>
        </ul>
        <h3>Non-Marketing Purposes</h3>
        <p>
          Pawndr, Inc greatly respects your privacy. We do maintain and reserve
          ...
          Pawndr, Inc products and services). In certain circumstances, we may
          use our website, newspapers, or other public means to post a notice.
        </p>
        <h3>Children under the age of 13</h3>
        <p>
          Pawndr, Inc’s website is not directed to, and does not knowingly
        ...
        <p>
          ...
          you wish to unsubscribe to support@gopawndr.com. If you wish to
          unsubscribe or opt-out from any third-party websites, you must go to
          that specific website to unsubscribe or opt-out. Pawndr, Inc will
        ...
        <p>
          ...
          Pawndr, Inc does not claim nor accept responsibility for any privacy
        ...
        <p>
          Pawndr, Inc’s operations are located primarily in the United States.
        ...
        <h3>Security</h3>
        <p>
          Pawndr, Inc takes precautions to protect your information. When you
        ...
        <p>
          Email: Support@gopawndr.com
          <br /> Mailing Address:
          <br /> Pawndr, Inc <br />
        </p>
        <p>Miami, Florida 33170</p>
        <p>GDPR Disclosure:</p>
        <p>
          ...
          (ii) have a data processing agreement with any third party vendors;
          (iii) appoint a data protection officer for the company to monitor
          GDPR compliance; (iv) designate a representative based in the EU under
          certain circumstances; and (v) have a protocol in place to handle a
          ...
          website at https://gdpr.eu. FormSwift and its subsidiaries are in no
          way responsible for determining whether or not your company is in fact
          compliant with GDPR and takes no responsibility for the use you make
          of this Privacy Policy or for any potential liability your company may
        ...
        <p>
          ...
          service must fulfill other requirements such as: (i) posting a privacy
          policy which describes not only your practices, but also the practices
          ...
          information, direct you to delete it, and refuse to allow any further
          collection or use of the child’s information, and the procedures to
          exercise their rights); (iv) give parents “direct notice” of your
          information practices before collecting information from their
          children; and (v) obtain the parents’ “verifiable consent” before
          collecting, using or disclosing personal information from a child. For
          more information on the definition of these terms and how to make sure
          your website or online service is fully compliant with COPPA please
          visit https://www.ftc.gov/tips-advice/business-
        ...
        <p>
          ...
          INCORPORATED HEREIN BY REFERENCE. IT IS THE RESPONSIBILITY OF YOU, THE
          USER, CUSTOMER, OR PROSPECTIVE CUSTOMER TO READ THE TERMS AND
          CONDITIONS BEFORE PROCEEDING TO USE THIS SITE. IF YOU DO NOT EXPRESSLY
          AGREE TO ALL OF THE TERMS AND CONDITIONS, THEN PLEASE DO NOT ACCESS OR
          USE OUR SITE OR OUR SERVICES.
        </p>
        <p>
          The present terms and conditions (this “Agreement” or “Terms”) is a
          legal agreement between you and Pawndr, Inc (hereinafter “Pawndr”), a
          company duly organized and validly existing, located at , Miami,
          Florida 33130. This Agreement annuls and voids all previous
          agreements.
        </p>
        <h3>OVERVIEW</h3>
        <p>
          The Site (http://www.gopawndr.com) is operated by Pawndr. Throughout
          the Site, the terms “we”, “us” and “our” refer to Pawndr. Pawndroffers
          ...
          content. In the event of an inconsistency between this Agreement and
          any additional terms or policies referenced herein, the provisions of
          the additional terms or policies shall control.
          <br />
          <br />
          ...
          these Terms. If you do not agree to all the Terms of this Agreement,
          then you may not access the Site or use any Service. If these Terms
          ...
          changes to our Site. It is your responsibility to check this page
        ...
        <p>
          ...
          Pawndrcontent is not for resale. Use of the Site does not entitle
          users to make any unauthorized use of any protected content, and in
          ...
          content without the express written permission of Pawndr and the
          ...
          express or implied, to the intellectual property of Pawndr or our
          licensors except as expressly authorized by these Terms.
        </p>
        <h3>SECTION 2 - CREATING an ACCOUNT</h3>
        <p>
          Once you create an account with us, you are registered on thePawndr
          Site. The terms “member,” “membership,” and “account” all refer to
          this registration as a member on Pawndr’s Site. If you are merely
          ...
          to any other person or entity. You acknowledge that Pawndr is not
          ...
          information in an effort to maintain accuracy and completeness at all
          times.
          <br />
          <br />
          If anyone knowingly provides any information of a false, untrue,
          inaccurate or incomplete nature,Pawndr, Inc will have sufficient
          grounds and rights to suspend or terminate the member in violation of
          this aspect of the Agreement, and as such refuse any and all current
          or future use of Pawndr, Inc Services, or any portion thereof.
        </p>
        ...
        <p>
          ...
          available by way of the Pawndr Services, and as such, we do not
          ...
          to content including, but not limited to, any errors or omissions in
          any content posted, and/or any loss or damage of any kind incurred as
          a result of the use of any content posted, emailed, transmitted or
          otherwise made available by Pawndr.
          <br />
          <br />
          Furthermore, you herein agree not to make use ofPawndr, Inc’s Services
          for the purpose of:
        </p>
        <div>
          <p>
            ...
            limited to, anyPawndr officials, forum leaders, guides or hosts or
            ...
            “junk mail,” “spam,” or any other form of solicitation, except in
            ...
            <br />
            <br />
            j. Interfering with or disrupting any Pawndr, IncServices, servers
            ...
            <br />
            <br />
            m. “stalking" or with the intent to otherwise harass another
            individual; and/or
            <br />
            <br />
        ...
        <p>
          Pawndr, Inc herein reserves the right to pre-screen, refuse and/or
        ...
        <p>
          Pawndr, Inc herein reserves the right to access, preserve and/or
        ...
        <ol>
          ...
          <li>
            Protecting the rights, property or the personal safety of Pawndr,
            Inc, its visitors, users and members, including the general public.
          </li>
        </ol>
        <p>
          Pawndr, Inc herein reserves the right to include the use of security
          components that may permit digital information or material to be
          protected, and that such use of information and/or material is subject
          to usage guidelines and regulations established by Pawndr, Inc or any
          other content providers supplying content services to Pawndr, Inc. You
          are hereby prohibited from making any attempt to override or
          circumvent any of the embedded usage rules in our Services.
        ...
        <p>
          ...
          <a
            href="http://www.treasury.gov/resource-
        ...
        <p>
          ...
          nor a member of any other government which may be part of an export-
          prohibited country identified in applicable export and import laws and
          regulations;
          <br />
          <br />
          ...
          nuclear, missile, chemical or biological weaponry end uses that would
          be a violation of the U.S. export laws; and
          <br />
          <br />
          d. Agree not to post, transfer nor upload any software, technology or
        ...
        <p>
          Pawndr, Inc shall not lay claim to ownership of any content submitted
          by any visitor, member, or user, nor make such content available for
          inclusion on our website Services. Therefore, you hereby grant and
          allow for Pawndr, Inc the below listed worldwide, royalty-free and
          non-exclusive licenses, as applicable:
        </p>
        <div>
          <p>
            a. The content submitted or made available for inclusion on the
            publicly accessible areas ofPawndr, Inc’s Sites, the license
            provided to permit to use, distribute, reproduce, modify, adapt,
            publicly perform and/or publicly display said Content on our network
            Services is for the sole purpose of providing and promoting the
            ...
            member of Pawndr, Inc’s sites, and shall terminate at such time when
            you elect to discontinue your membership.
            <br />
            <br />
            b. Photos, audio, video and/or graphics submitted or made available
            for inclusion on the publicly accessible areas oPf awndr, Inc’s
            ...
            as you are a member of Pawndr, Inc’s sites and shall terminate at
            such time when you elect to discontinue your membership.
            <br />
            <br />
            c. For any other content submitted or made available for inclusion
            on the publicly accessible areas oPf awndr, Inc’s sites, the
            continuous, binding and completely sub-licensable license which is
            meant to permit to use, distribute, reproduce, modify, adapt,
            publish, translate, publicly perform and/or publicly display said
            content, whether in whole or in part, and the incorporation of any
            such Content into other works in any arrangement or medium current
            used or later developed.
          </p>
        </div>
        <p>
          Those areas which may be deemed “publicly accessible” areas ofPawndr,
          Inc’s Sites are those such areas of our network properties which are
          meant to be available to the general public, and which would include
          message boards and groups that are openly available to both users and
          members. However, those areas which are not open to the public, and
          thus available to members only, would include our mail system and
          instant messaging.
        </p>
        <h3>CONTRIBUTIONS to COMPANY WEBSITE</h3>
        <p>
          Pawndr, Inc may provide an area for our user and members to contribute
          feedback to our website. When you submit ideas, documents, suggestions
          and/or proposals (“Contributions”) to our site, you acknowledge and
          agree that:
        </p>
        <div>
          <p>
            ...
            <br />
            <br />
            b. Pawndr shall not be liable or under any obligation to ensure or
            maintain confidentiality, expressed or implied, related to any
            Contributions;
            <br />
            <br />
            c. Pawndr shall be entitled to make use of and/or disclose any such
            Contributions in any such manner as they may see fit;
            <br />
            <br />
            d. The contributor’s Contributions shall automatically become the
            sole property ofPawndr; and
            <br />
            <br />
            e. Pawndr is under no obligation to either compensate or provide any
            form of reimbursement in any manner or nature.
          </p>
        </div>
        <h3>SECTION 6 - INDEMNITY</h3>
        <p>
          All users and/or members agree to insure and holdPawndr, Inc, our
          ...
          through our Services, the use of Pawndr Services or your connection
          with these Services, your violations of the Terms of Service and/or
        ...
        <p>
          ...
          use of, or access to Pawndr’s sites.
        </p>
        <h3>SECTION 8 - MODIFICATIONS</h3>
        <p>
          Pawndr, Increserves the right at any time it may deem fit, to modify,
          alter and or discontinue, whether temporarily or permanently, our
          service, or any part thereof, with or without prior notice. In
        ...
        <p>
          As a member of http://www.gopawndr.com, you may cancel or terminate
          your account, associated email address and/or access to our Services
          by submitting a cancellation or termination request to .
          <br />
          <br />
          As a member, you agree that Pawndr, Inc may, without any prior written
          notice, immediately suspend, terminate, discontinue and/or limit your
          account, any email associated with your account, and access to any of
          our Services. The cause for such termination, discontinuance,
          ...
          <span>
            ...
            agreement, regulation and/or guideline; b. By way of requests from
            law enforcement or any other governmental agencies; c. The
            discontinuance, alteration and/or material modification to our
            Services, or any part thereof; d. Unexpected technical or security
            issues and/or problems; e. Any extended periods of inactivity; f.
            Any engagement by you in any fraudulent or illegal activities;
            and/or g. The nonpayment of any associated fees that may be owed by
            you in connection with your http://www.gopawndr.comaccount Services.
          </span>
        </p>
        <p>
          ...
          <br />
          <span>
            The termination of your account with http://www.gopawndr.com shall
            include any and/or all of the following:
          </span>
          <span>
            a. The removal of any access to all or part of the Services offered
            within http://www.gopawndr.com;
            <br />
            <br />
            b. The deletion of your password and any and all related
            information, files, and any such content that may be associated with
            or inside your account, or any part thereof; and
            <br />
            <br />
        ...
        <p>
          Either Pawndr, Inc or any third parties may provide links to other
          ...
          you acknowledge and agree that Pawndr, Inc shall not be responsible or
        ...
        <p>
          You do hereby acknowledge and agree that Pawndr, Inc’s Services and
          ...
          and other laws. Furthermore, you herein acknowledge and agree that any
          ...
          applicable law or as authorized by Pawndr, Inc or such applicable
          ...
          plagiaristic works which are based on Pawndr, Inc Services (e.g.
          Content or Software), in whole or part.
          <br />
          <br />
          Pawndr, Inc hereby grants you a personal, non-transferable and
          ...
          which is provided by Pawndr, Inc for use in accessing our Services.
        </p>
        ...
        <p>
          ...
          <br />
          <span>
            a. The use of pawndr, inc services and software are at the sole risk
            by you. our services and software shall be provided on an “as is”
            and/or “as available” basis. pawndr, inc and our subsidiaries,
            ...
            <br />
            <br />
            b. Pawndr, inc and our subsidiaries, officers, employees, agents,
            partners and licensors make no such warranties that (i) pawndr, inc
            services or software will meet your requirements; (ii) pawndr, inc
            ...
            use of the pawndr, inc services or software will be accurate or
            ...
            way of pawndr, inc services or software shall be accessed by your
            ...
            that may be obtained by you from pawndr, inc or by way of or from
            our services or software shall create any warranty not expressly
            stated in the terms.
            <br />
            <br />
            ...
            shown no history of any prior seizure or epilepsy. should you,
        ...
        <p>
          You explicitly acknowledge, understand and agree that pawndr, inc and
          ...
          <br />
          <span>
            a. Use or inability to use our service;
            <br />
            <br />
            b. The cost of procuring substitute goods and services;
            <br />
            <br />
            c. UNAUTHORISED access to or the alteration of your transmissions
            and/or data;
            <br />
            <br />
        ...
        <p>
          In the event you have a dispute, you agree to releasePawndr, Inc(and
          ...
          and nature, known and unknown, suspected or unsuspected, disclosed and
          undisclosed, arising out of or in any way connected to such dispute.
        </p>
        <h3>SECTION 15 - NOTICE</h3>
        <p>
          Pawndr, Inc may furnish you with notices, including those with regards
          to any changes to the Terms, including but not limited to email,
          ...
          be herein after developed. Any such notices may not be received if you
          violate any aspects of the Terms by accessing our Services in an
          unauthorized manner. Your acceptance of this Agreement constitutes
          your agreement that you are deemed to have received any and all
          notices that would have been delivered had you accessed our Services
          in an authorized manner.
        </p>
        <h3>SECTION 16 - INTELLECTUAL PROPERTY RIGHTS</h3>
        <p>
          You herein acknowledge, understand and agree that all of thePawndr,
          Inctrademarks, copyright, trade name, service marks, and otherPawndr,
          Inclogos and any brand features, and/or product and service names are
          trademarks and as such, are and shall remain the property oPf awndr,
          Inc. You herein agree not to display and/or use in any manner the
          Pawndr, Inclogo or marks without obtaining Pawndr, Inc’s prior written
          consent.
          <br />
          <br />
          Pawndr, Inc will always respect the intellectual property of others,
          and we ask that all of our users do the same. With regards to
          appropriate circumstances and at its sole discretion, Pawndr, Inc may
          ...
          work has been duplicated in such a way that would constitute copyright
          ...
          <br />
          <span>
            a. The electronic or the physical signature of the individual that
            ...
            <br />
            <br />
            c. A description of the location of the site which you allege has
            ...
            <br />
            <br />
            e. A statement, in which you state that the alleged and disputed use
            of your work is not authorized by the copyright owner, its agents or
            the law;
            <br />
            <br />
            f. And finally, a statement, made under penalty of perjury, that the
            aforementioned information in your notice is truthful and accurate,
            and that you are the copyright or intellectual property owner,
            representative or agent authorized to act on the copyright or
            intellectual property owner’s behalf.
          </span>
          <br />
          <br />
          The Pawndr, Inc agent for notice of claims of copyright or other
          intellectual property infringement can be contacted as follows:
          Mailing Address: Pawndr, Inc Attn: Copyright Agent Miami, Florida
          33130
          <br />
          <br />
          Telephone: Email: Support@gopawndr.com
        </p>
        <h3>SECTION 17 - ENTIRE AGREEMENT</h3>
        <p>
          This Agreement constitutes the entire agreement between you andPawndr,
          Incand shall govern the use of our Services, superseding any prior
          version of this Agreement between you and us with respect to Pawndr,
          Inc Services. You may also be subject to additional terms and
          conditions that may apply when you use or purchase certain other
          Pawndr, Inc Services, affiliate Services, third-party content or
          third-party software.
        </p>
        <h3>SECTION 18 - CHOICE of LAW and FORUM</h3>
        <p>
          It is at the mutual agreement of both you andPawndr, Inc with regard
          to the Agreement that the relationship between the parties shall be
          governed by the laws of the state of Florida without regard to its
          conflict of law provisions and that any andall claims, causes of
          action and/or disputes, arising out of or relating to the Agreement,
          or the relationship between you and Pawndr, Inc, shall be filed within
          the courts having jurisdiction within the County of Miami Dade,
          Florida or the U.S. District Court located in said state. You
          andPawndr, Inc agree to submit to the jurisdiction of the courts as
        ...
        <p>
          At any time, should Pawndr, Inc fail to exercise or enforce any right
          or provision of the Agreement, such failure shall not constitute a
        ...
        <p>
          ...
          or law to the contrary, any claim or action arising out of or related
          to the use of our Services or the Agreement must be filed within 3
          year(s) after said claim or cause of action arose or shall be forever
          barred.
        </p>
        <h3>SECTION 22 - VIOLATIONS</h3>
        <p>
          Please report any and all violations of this Agreement toPawndr, Inc
          as follows:
          <br />
          <br />
          Mailing Address: Pawndr, Inc Miami, Florida 33130
          <br />
          <br />
          Telephone: Email: Support@gopawndr.com
        </p>
        ...
        <p>
          The Site is controlled, operated and administered by Pawndrfrom our
          offices within the USA. If you access the Site from a location outside
          the USA, you are responsible for compliance with all local laws. You
          agree that you will not use Pawndr’s content accessed through the Site
        ...
        <p>
          ...
          information or cancel orders if any information on the Site or on any
          related Site is inaccurate at any time without prior notice (including
          after you have submitted your order).
          <br />
          <br />
          We undertake no obligation to update, amend or clarify information on
          the Site or on any related Site, including without limitation, pricing
          ...
          indicate that all information on the Site or on any related Site has
          been modified or updated.
        </p>
        <h3>SECTION 26 - PRIVACY POLICY</h3>
        <p>
          Every member’s registration data and various other personal
          information are strictly protected by thePawndr, Inc Online Privacy
          Policy (see the full Privacy Policy at:
        </p>
        <p>
          ...
          Pawndr, Inc and/or our subsidiaries and affiliates.
        </p>
        <p>
          <a href="https://formswift.com/free-write/edit-shared.php?sharekey=qp6k8zps2zxx3ntdyema&utm_campaign=recipient_send_pdf&utm_content=recipient_send_pdf&utm_source=sendgrid&utm_medium=email">
            https://formswift.com/free-write).
          </a>
        </p>
      </div>
    </section>
